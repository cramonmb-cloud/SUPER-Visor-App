                  ...
                  {(client.avales && client.avales.length > 0 ? client.avales : [{ name: client.avalName, visitTimestamp: client.avalVisitTimestamp, facadeUrl: client.avalFacadeUrl, photoUrl: client.avalPhotoUrl }]).map((aval, idx) => {
                      ...
                      return (
                          <button 
                              ...
                              className={`flex-1 min-w-[120px] py-1.5 px-3 rounded-lg font-black text-[9px] uppercase tracking-widest transition-all flex items-center justify-center gap-1.5 shadow-sm active:scale-95 ${
                                isVisited ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' : 
